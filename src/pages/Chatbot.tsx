        ...
        <div className="mx-auto w-[90%] sm:w-[80%] md:w-[75%] lg:w-[70%]">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center px-1 sm:px-2 lg:px-4">
              ...
              <div>
                <div className="mb-6">
                  ...
                  <div className="flex justify-center lg:justify-start mb-4">
                    <div className="inline-flex items-center gap-2 glass-container rounded-full px-4 py-2">
                      <span className="text-sm font-medium text-white">Get first month for 1$</span>
                    </div>
                  </div>
                ...
                {/* Iframe Embed */}
                <div className="w-full overflow-hidden -mx-4 lg:mx-0 flex justify-center lg:justify-start">
            ...
            <div className="flex justify-center pt-12 sm:pt-16">
              <div className="relative w-full flex justify-center lg:justify-end pt-2 lg:pt-0">
                <video 
