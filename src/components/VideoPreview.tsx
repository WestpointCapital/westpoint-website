        ...
        <div className="fixed bottom-6 right-6 z-[999999999] animate-in slide-in-from-bottom-5 duration-300">
          <div className="relative group">
            ...
            <div 
              ...
              className="rounded-2xl cursor-pointer transform transition-all duration-300 hover:scale-105 w-56 sm:w-64 md:w-72 lg:w-80"
              style={{ 
            ...
            >
              <div className="shadow-2xl overflow-hidden rounded-2xl">
                {/* Title */}
                <div className="px-2 sm:px-3 md:px-4 pt-2 sm:pt-3 md:pt-4 pb-1 sm:pb-2 text-center">
                  <p className="text-xs sm:text-sm md:text-lg font-medium text-white">Watch introvideo</p>
                </div>

                {/* Video Thumbnail */}
                <div className="relative aspect-video mx-2 sm:mx-3 md:mx-4 mb-2 sm:mb-3 md:mb-4 rounded-lg overflow-hidden">
                <img 
