  ...
  return (
    <section className="py-24 bg-slate-950">
      <div className="mx-auto px-6 sm:px-8 w-[90%] sm:w-[80%] md:w-[75%] lg:w-[70%]">
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative">
                <img 
                  ...
                  className="max-w-full h-auto scale-60"
                />
              </div>
            </div>
          </div>
        ...
        <div className="glass-container rounded-2xl px-3 py-0 bg-gradient-to-r from-slate-800/50 to-slate-900/50 border border-blue-500/20 mt-24 -my-6">
          <div className="grid lg:grid-cols-2 gap-2 items-center">
            
            {/* Left Side - Text Content */}
            <div className="space-y-3 text-center lg:text-left max-w-lg ml-8">
              <div>
                <h2 className="font-bold mb-3 text-white" style={{ fontSize: '48px', lineHeight: '48px' }}>
                  Make every customer feel <span className="text-blue-400">special and seen</span>
                </h2>
                <p className="text-lg text-white/70 leading-tight mb-3">
